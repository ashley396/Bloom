      ...
      <div className="mx-auto flex min-h-svh max-w-[1680px] flex-col lg:flex-row">
        ...
        >
          <div className="flex items-center gap-2.5">
            <span
              className="bg-gradient-brand shadow-button flex size-9 shrink-0 items-center justify-center rounded-xl text-[15px] font-semibold text-white"
              aria-hidden
            >
              F
            </span>
            <div>
              <p className="font-serif-display text-xl font-semibold leading-none text-charcoal">
                Florisyn
              </p>
              <p className="mt-1.5 text-xs text-sage-ink">Lilies in Bloom</p>
            </div>
          </div>
