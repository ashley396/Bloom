...
async function loadOverview(){
  ...
  if($('#adminMetrics'))$('#adminMetrics').hidden=false;$('#adminMetrics').innerHTML=[
...
/* editor tabs wired via document delegation */
